  ...
  Widget build(BuildContext context) {
    final items = <_ItemMenu>[
      const _ItemMenu(
        'Établissements',
        Icons.school,
        EtablissementListeScreen(),
      ),
      if (pourCepe)
        const _ItemMenu(
          'Écoles d\'origine (CEPE)',
          Icons.home_work,
          EcoleOrigineCepeListeScreen(),
        )
      else
        const _ItemMenu(
          'Écoles d\'origine (BEPC)',
          Icons.home_work,
      ...
      if (pourCepe)
        const _ItemMenu(
          'CEG d\'accueil',
          Icons.location_city,
          CegAccueilListeScreen(),
        )
      else
        const _ItemMenu(
          'Lycée d\'accueil',
          Icons.location_city,
          LyceeAccueilListeScreen(),
        ),
      if (pourCepe)
        const _ItemMenu(
          'Centres d\'écrit (CEPE)',
          Icons.edit_document,
          CentreEcritCepeListeScreen(),
        )
      else
        const _ItemMenu(
          'Centres d\'écrit (BEPC)',
          Icons.edit_document,
          CentreEcritBepcListeScreen(),
        ),
      if (pourCepe)
        const _ItemMenu(
          'Centres de correction (CEPE)',
          Icons.fact_check,
          CentreCorrectionCepeListeScreen(),
        )
      else
        const _ItemMenu(
          'Centres de correction (BEPC)',
          Icons.fact_check,
      ...
      if (pourCepe)
        const _ItemMenu(
          'Groupes (A, B, C)',
          Icons.groups,
          GroupeCepeListeScreen(),
        )
      else
        const _ItemMenu(
          'Groupes (I, II, III)',
          Icons.groups,
          GroupeBepcListeScreen(),
        ),
      const _ItemMenu(
        'Types de handicap',
        Icons.accessible,
        TypeHandicapListeScreen(),
      ),
      // Langue et sports (EPS) ne concernent que le BEPC, pas le CEPE.
      if (!pourCepe) ...[
        ...
        itemBuilder: (ctx, i) {
          ...
          return Card(
            ...
            child: ListTile(
              ...
              onTap: () => Navigator.of(
                context,
              ).push(MaterialPageRoute(builder: (_) => item.ecran)),
            ),
          );
        },
      ),
